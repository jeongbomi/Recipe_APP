<template>
  <div class="recipe-one">
    ...
    <div class="table">
      ...
      <h3>&nbsp&nbsp재료 정보</h3>
      <hr style="width:100%;" />
      <h4>{{MyItems.qnt}} 기준</h4>

      <button id="test_btn1">주재료</button>
      <br />
      <div v-for="(value, index) in MyItems.ingredients[0].주재료 " style="display:inline;">
        <div v-for="(item, index2) in value" style="display:inline;">
          {{index2}}&nbsp{{item}}
      ...
      <br />
      <div v-for="(value, index) in MyItems.ingredients[0].부재료 " style="display:inline;">
        <div v-for="(item, index2) in value" style="display:inline;">
          {{index2}}&nbsp{{item}}
      ...
      <br />
      <br />
      <button id="test_btn3">&nbsp양념&nbsp</button>
      <br />
      <div v-for="(value, index) in MyItems.ingredients[0].양념 " style="display:inline;">
        <div v-for="(item, index2) in value" style="display:inline;">
          {{index2}}&nbsp{{item}}
    ...
    <div class="table2">
      ...
      <h3>&nbsp&nbsp레시피 정보</h3>
      <hr style="width:100%;" />

      <div v-if="MyItems.nation=='한식'" style="display:inline;">
        <p>국가&nbsp:&nbsp{{MyItems.nation}}</p>
    ...
    <div class="table3">
      ...
      <h3>&nbsp&nbsp레시피 과정</h3>
      <hr style="width:100%;" />

      <div v-for="(value, index) in MyItems.info " style="display:inline;">
        <h2>STEP {{index + 1}}</h2>
